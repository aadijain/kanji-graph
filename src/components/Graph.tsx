...
export default function Graph() {
  ...
  // Focus-mode neighbors (hover-mode neighbors live in hoverNeighborsRef inside GraphCanvas).
  ...
  return (
    <div ref={wrapperRef} className="absolute inset-0">
      <GraphCanvas
        ...
        settings={settings}
        hoveredId={hoveredId}
        hoveredKanji={hoveredKanji}
        hoveredReading={hoveredReading}
        COLORS={COLORS}
        setHovered={setHovered}
        setFocused={setFocused}
        tryApplyPendingFocus={tryApplyPendingFocus}
      />
    </div>
  );
}
